# Pref key → body naming align — IEG (APPLIED)
...
**Pref root:** `C:/Users/user/Documents/GitHub/prefaces_ieg/prefaces`
...
```text
python scripts/pref_key_body_align.py --dict IEG --apply
```

---

_H1571 · Grok 4.5 (`grok-4.5`) · APPLIED._
