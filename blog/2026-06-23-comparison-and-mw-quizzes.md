...
- a **live side-by-side dictionary comparison** — type one Sanskrit word and read its entry
  across Monier-Williams, Apte, Böhtlingk-Roth, and Grassmann at once, fetched live from the
  Cologne CDSL API, and
- a **"Reading Monier-Williams" guide with 69 practice quizzes** — the four levels of MW's
  alphabetical order, its symbols, and tracing a word to its dhātu, with self-check questions
  that link straight to live CDSL entries.
