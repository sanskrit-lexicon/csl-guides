...
[`index.rst`](https://github.com/sanskrit-lexicon/csl-doc/blob/main/source/dictionaries/index.rst)
...
([abch.rst](https://github.com/sanskrit-lexicon/csl-doc/blob/main/source/dictionaries/abch.rst));
...
- **Wilson vs Yates** — *separate dictionaries.* csl-doc has distinct
  [wil.rst](https://github.com/sanskrit-lexicon/csl-doc/blob/main/source/dictionaries/wil.rst)
  and [yat.rst](https://github.com/sanskrit-lexicon/csl-doc/blob/main/source/dictionaries/yat.rst)
...
- **`PW` display code** — confirmed by
  [pw.rst](https://github.com/sanskrit-lexicon/csl-doc/blob/main/source/dictionaries/pw.rst)
...
- **Publisher / place / edition statements** — author, descriptive title, and page count
  ...
  the csl-doc [`prefaces/`](https://github.com/sanskrit-lexicon/csl-doc/tree/main/source/dictionaries/prefaces)
  pages.
