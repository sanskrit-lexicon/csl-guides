...
releases, see the History timeline; for the publications it rests on, see
...
| **Now** | Version **<SiteVersion />**; **42** fully digitized dictionaries (plus the `PD` sample), source in the `v02` layout of [`csl-orig`](https://github.com/sanskrit-lexicon/csl-orig); see the catalog. | The Sanskrit Library continues its [presentation of the Cologne dictionaries](https://sanskritlibrary.org/cologne.html). |
