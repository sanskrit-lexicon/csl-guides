...
### Added
- **Preface enrichment P0 plan set** — `docs/plans/PLAN_csl-guides_preface_enrichment_P0_2026-07.md` + roadmap/architecture/implementation/verification (ask-batch from enrichment use-cases doc).
