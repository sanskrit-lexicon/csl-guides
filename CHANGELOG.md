...
### Added
- **PWG/PW `pref_only` decomposition** ([H1560](https://github.com/gasyoun/Uprava/blob/main/handoffs/H1560-Sonnet_csl-guides_pref-only-pwg-pw-decompose_24.07.26.md), [#123](https://github.com/sanskrit-lexicon/csl-guides/issues/123)) — residual after case+diacritic fold is **typed** (`ortho` / `rare` / `ocr_key` / `spacing` / `true_unused` / `ambiguous`), not “unused abbreviations.” Classifier [`scripts/pref_only_decompose.py`](https://github.com/sanskrit-lexicon/csl-guides/blob/main/scripts/pref_only_decompose.py); top-50 samples + rollup under [`scripts/out/PWG_PW_pref_only_decompose.md`](https://github.com/sanskrit-lexicon/csl-guides/blob/main/scripts/out/PWG_PW_pref_only_decompose.md). **No bulk pref overwrite.**
