...
Indexed on the site: OCR'd prefaces (includes the **FAIR path map**: METHODS ·
naming authority · [legend emit](https://github.com/sanskrit-lexicon/csl-guides/blob/main/scripts/pref_legend_emit.py)).
