...
import { fetchIndexesByWorker, searchByWorker } from "@easyops-cn/docusaurus-search-local/dist/client/client/theme/searchByWorker.js";
import { SuggestionTemplate } from "./SuggestionTemplate";
import { EmptyTemplate } from "./EmptyTemplate";
import { SearchDocumentType } from "@easyops-cn/docusaurus-search-local/dist/client/shared/interfaces.js";
import { Mark, searchBarShortcut, searchBarShortcutHint, searchBarShortcutKeymap, searchBarPosition, docsPluginIdForPreferredVersion, searchContextByPaths, hideSearchBarWithNoSearchContext, useAllContextsWithNoSearchContext, askAi, } from "@easyops-cn/docusaurus-search-local/dist/client/client/utils/proxiedGenerated.js";
import LoadingRing from "@easyops-cn/docusaurus-search-local/dist/client/client/theme/LoadingRing/LoadingRing.jsx";
import { normalizeContextByPath } from "@easyops-cn/docusaurus-search-local/dist/client/client/utils/normalizeContextByPath.js";
import { searchResultLimits } from "@easyops-cn/docusaurus-search-local/dist/client/client/utils/proxiedGeneratedConstants.js";
import { parseKeymap, matchesKeymap, getKeymapHints } from "@easyops-cn/docusaurus-search-local/dist/client/client/utils/keymap.js";
import { isMacPlatform } from "@easyops-cn/docusaurus-search-local/dist/client/client/utils/platform.js";
import styles from "./SearchBar.module.css";
import { normalizeOrthoQuery, ORTHO_QUERY_NORMALIZER } from "../../ortho/normalizeQuery.mjs";
void ORTHO_QUERY_NORMALIZER;
        ...
        search.current = autoComplete(searchBarRef.current, {
        ...
        }, [
            {
                source: async (input, callback) => {
                    // H3340: expand the query through the vendored
                    // SanskritSpellCheck reform maps (Thier->Tier,
                    // августъ->август) before it reaches the lunr worker.
                    const result = await searchByWorker(versionUrl, searchContext, normalizeOrthoQuery(input), searchResultLimits);
                    if (input && askAi) {
                        callback([
                            {
                                document: {
