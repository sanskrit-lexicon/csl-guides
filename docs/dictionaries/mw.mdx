...
flagship guide page — for most other dictionaries the catalog links straight to
...
- Use **Böhtlingk-Roth (PWG)** (German) for the deepest scholarly treatment and
...
1. Open the **Basic** display and pick your **input** transliteration (see
   Encoding & Transliteration — MW defaults to
   *Kyoto-Harvard*).
...
Search & Display for all four modes.
...
- **Inflected forms.** A companion **MW inflected-forms** resource maps inflected words back
  ...
  Tools → Multi-Dictionary (`/scans/csl-inflect/web/index.php`).
...
- **Reading Monier-Williams (with quizzes)** — the four
