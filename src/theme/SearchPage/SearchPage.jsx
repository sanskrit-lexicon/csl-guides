...
import useSearchQuery from "@easyops-cn/docusaurus-search-local/dist/client/client/theme/hooks/useSearchQuery.js";
...
import { Mark, searchContextByPaths, useAllContextsWithNoSearchContext, } from "@easyops-cn/docusaurus-search-local/dist/client/client/utils/proxiedGenerated.js";
...
function SearchPageContent() {
    ...
    useEffect(() => {
        ...
        if (searchQuery) {
            (async () => {
                // H3340: ortho-drift query expansion (see SearchBar.jsx).
                const results = await searchByWorker(versionUrl, searchContext, normalizeOrthoQuery(searchQuery), 100);
